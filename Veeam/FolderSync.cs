...
namespace Veeam
{
    public class FolderSync
    {
        ...
        private void SyncFolder(string sourcePath, string destinationPath)
        {
            ...
            {
                using (var md5 = MD5.Create()) // Create a new instance for each file
                {
            ...
            Parallel.ForEach(destSubDirs, (subDir) =>
            {
                ...
                {
                    subDir.Delete(true); // true pentru a șterge recursiv
        ...
        private void Log(string message)
        {
            ...
            {
                // Poți înlocui cu o afișare pe consolă a erorii sau să înregistrezi în alt mod
